<h1> Day 1 : Introduction to NGS and Galaxy </h1>
<table class="table table-hover table-condensed" border=1; style="width:800px;">
    ...
    <tr>
        ...
        <td style="padding:5px"> <font size="3"> Assessing Read Quality, Trimming and Filtering
             <font size="2"><i><br>
               ...
               - How can I check if my sample is contaminated ? <br>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="padding:5px"> <font size="3"> Assembly and assembly statistics
             <font size="2"><i><br>
             - 
        </td>
    </tr>
...
<br>
<h1> Day 2 : Bacterial Characterization </h1>
<table class="table table-hover table-condensed" border=1; style="width:800px;">
    <thead style="background-color:{{config.extra.color_table_header}}";>
         <tr>
            <td style="color:white; padding:5px; width:75px"> <font size="3"><b> Time </b> </td>
    ...
    <tr>
        <td style="padding:5px"> <font size="3"> 09:00 </td>
        <td style="padding:5px"> <font size="3"> Sequence typing (Multi Locus Sequence Typing) and Strain serotype
             <font size="2"> <i><br>
             - 
             </i>
        </td>
    ...
    <tr>
        <td style="padding:5px"> <font size="3"> 10:45 </td>
        <td style="padding:5px"> <font size="3"> AMR and virulence gene detection
             <font size="2"> <i><br>
             -  
             </i>
        </td>             
    ...
    <tr>
        <td style="padding:5px"> <font size="3"> 13:00 </td>
        <td style="padding:5px"> <font size="3"> Genome Annotation
 <font size="2"> <i><br>
             -
             - 
             </i>
    ...
    <tr>
        <td style="padding:5px"> <font size="3"> ? </td>
        <td style="padding:5px"> <font size="3"> Bonus: Core gene alignment and core genome-based clustering </td>
        <td style="padding:5px"> <font size="3">  </td>
    </tr>
</table>
